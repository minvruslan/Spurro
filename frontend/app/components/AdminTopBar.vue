...
<template>
  <header class="sticky top-0 z-10 border-b border-border bg-background py-3.5">
    <div class="mx-auto flex w-full max-w-205 items-center justify-between gap-2 px-4 sm:px-7">
      <div class="flex items-center gap-3 sm:gap-6">
        ...
        <nav :aria-label="t('navLabel')" class="flex items-center gap-0.5">
          <NuxtLink
            ...
            class="inline-flex items-center gap-1.5 whitespace-nowrap rounded-md px-2.5 py-1.5 text-sm font-medium outline-none transition-colors hover:bg-accent hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/50 sm:px-3"
